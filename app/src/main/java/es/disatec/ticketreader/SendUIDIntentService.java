 ...
 * helper methods.
 */
public class SendUIDIntentService extends IntentService {
    ...
    public SendUIDIntentService() {
        super("SendUIDIntentService");
    }
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, SendUIDIntentService.class);
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        TicketServerWS.SendUIDtoServer(TicketConstants.UID,tockenId);
    }
